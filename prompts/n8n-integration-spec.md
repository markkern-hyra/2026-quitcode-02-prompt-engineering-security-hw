...
tested-on: docs/sanitized-brief.md — claude -p (Opus 4.5, лише читання), v1 і v2, 2026-09-14; лог — docs/prompt-runs/06-n8n-integration-spec.md
version: 2
---
...
| v2 | ✅ + мапа ручного процесу («Google Sheets — виключено»), питання про автентифікацію вебхука | ❌ Airtable **знову** «на здогад» — текстовий критерій не спрацював; виправлення — в брифі (явна роль Airtable), а не в промпті |
