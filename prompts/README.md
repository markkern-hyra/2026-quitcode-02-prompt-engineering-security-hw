...
- **Де модель упевнена, текстовий критерій не допомагає:** `n8n-integration-spec`
  двічі призначив Airtable роль «на здогад», попри пряму заборону. Такі речі
  виправляються в даних (бриф), а не ще одним рядком у промпті.
