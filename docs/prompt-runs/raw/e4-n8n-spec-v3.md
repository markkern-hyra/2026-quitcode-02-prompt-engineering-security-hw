...
> **Застарілий вихід.** Другий раунд рев'ю CodeRabbit знайшов у цій специфікації прогалини: credentials поза брифом без позначки, секрет у query-параметрі як запасний варіант, захист від повторів без ID події, неідемпотентні повтори CRM, відсутні вимоги до HTTPS і редиректів, спільний credential сховищ, «10 цифр» при 9 у regex. Промпт виправлено у v4 — див. прогін [`g1-n8n-spec-v4`](./g1-n8n-spec-v4.md) і `docs/prompt-runs/06-n8n-integration-spec.md` (06e). Сам вихід не редагується — це доказ.
